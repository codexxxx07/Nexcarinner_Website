      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <a
            ...
            className={cn(
              'flex h-10 w-10 items-center justify-center rounded-full border transition-all duration-300 ease-out hover:scale-110 hover:shadow-[0_6px_14px_-4px_rgba(34,29,58,0.25)]',
