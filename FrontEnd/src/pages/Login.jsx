  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md px-6 pb-24 pt-16 lg:px-8">
        ...
        <Reveal delay={60}>
          <span className="chip mt-8">Welcome back</span>
        </Reveal>
        <Reveal delay={120}>
          <h1
          ...
          >
            Sign in to <span className="text-gradient-animate">Nexcarinner</span>
          </h1>
        </Reveal>
        <Reveal delay={180}>
          <p
          ...
          >
            Welcome back to the community. Let's get you back to building.
          </p>
        </Reveal>
          ...
          <div className="glass relative mt-10 overflow-hidden rounded-3xl p-8 sm:p-10">
            ...
            {submitted ? (
              <div className="relative flex min-h-96 flex-col items-center justify-center text-center">
                ...
                >
                  Welcome back, {formData.email || 'friend'}. The community missed you.
                </p>
                <Button
