...
import AnkurImg from "../assets/images/Ankur.jpg";
import KrishImg from "../assets/images/Krish.jpg";
import LakshyaImg from "../assets/images/Lakshya.jpg";
import SauryaImg from "../assets/images/Saurya.jpg";
import ShadowImg from "../assets/images/Shadow.jpg";
import PahuImg from "../assets/images/Pahu.jpg";
import SurajitImg from "../assets/images/Surajit.jpg";
import GourabImg from "../assets/images/Gourab.jpg";
...
const team = [
  {
    ...
    role: "Founder",
    description:
      "Visionary behind NexCarInner, leading the community with ideas, direction, and long-term goals",
    image: GunjanImg,
    initials: "GK",
    gradient: "from-brand-500 to-flare-pink",
    socials: {
  ...
  },
  {
    ...
    role: "Co-Founder",
    description:
      "Co-driving the mission, supporting growth, strategy, and overall execution of the community",
    image: SauryaImg,
    initials: "SY",
    gradient: "from-flare-cyan to-brand-500",
    socials: {
  ...
  },
  {
    ...
    description:
      "Managing the community while leading the tech side, building and maintaining the platform from scratch",
    image: KrishImg,
    initials: "KR",
    gradient: "from-flare-pink to-brand-500",
    socials: {
  ...
  },
  {
    ...
    description:
      "Handling community engagement while driving data-focused initiatives and insights",
    image: SurajitImg,
    initials: "SJ",
  ...
  },
  {
    ...
    description:
      "Responsible for onboarding talent and growing the team with the right people",
    image: PahuImg,
    initials: "PP",
  ...
  },
  {
    ...
    description:
      "Ensuring smooth communication and coordination within the community",
    image: GourabImg,
    initials: "PP",
    gradient: "from-brand-600 to-flare-pink",
    socials: {
  ...
  },
  {
    ...
    description:
      "Finding and sharing valuable opportunities, resources, and updates for the community",
    image: null,
    initials: "SD",
    gradient: "from-brand-600 to-flare-pink",
    socials: {
  ...
  },
  {
    ...
    role: "AIML Mentor",
    description:
      "Guiding members in AI/ML, helping them learn and grow in the field",
    image: AnkitaImg,
    initials: "AK",
    gradient: "from-flare-cyan to-flare-pink",
    socials: {
  ...
  },
  {
    ...
    description:
      "Supporting full-stack development learning and sharing resources with the team",
    image: AnkurImg,
    initials: "AK",
    gradient: "from-flare-cyan to-flare-pink",
    socials: {
  ...
  },
  {
    ...
    description:
      "Guiding members to understand cybersecurity and ethical hacking fundamentals",
    image: ShadowImg,
    initials: "AK",
    gradient: "from-flare-cyan to-flare-pink",
    socials: {
  ...
  },
  {
    ...
    description:
      "Guiding members in data analytics, helping them understand data, tools and real-world insights",
    image: LakshyaImg,
    initials: "AK",
    gradient: "from-flare-cyan to-flare-pink",
    socials: {
...
const timeline = [
  {
    ...
    title: "The spark",
    description:
      "Nexcarinner is founded with a simple idea: connect student developers who care.",
  },
  {
    year: "2025",
    title: "First hackathon",
    description:
      "Our inaugural hackathon brings in 100+ participants and 20 shipped projects.",
  },
  {
    year: "2026",
    title: "The expansion",
    description:
      "500+ members across six communities, with mentorship and demo days every month.",
  },
];
...
const socialConfig = [
  {
    ...
    label: "LinkedIn",
    icon: FaLinkedin,
    hover: socialHover.linkedin,
  },
  {
    key: "instagram",
    label: "Instagram",
    icon: FaInstagram,
    hover: socialHover.instagram,
  },
      ...
      <section className="mx-auto max-w-7xl px-6 pb-6 pt-16 text-center lg:px-8 lg:pt-24">
        ...
        <Reveal delay={100}>
          ...
          >
            ...
            <span className="text-gradient-animate">a launchpad</span>
          </h1>
        </Reveal>
        <Reveal delay={200}>
          <p
          ...
          >
            Nexcarinner exists to help students level up, find their people, and
            build things worth showing off.
          </p>
        </Reveal>
      </section>
                ...
                {[
                  {
                    ...
                    description:
                      "Move beyond theory and gain practical experience through real projects, challenges, hackathons, and hands-on learning.",
                  },
                  {
                    title: "Grow Together",
                    description:
                      "Build a supportive community where students collaborate, share knowledge, help each other, and learn together.",
                  },
                  {
                    title: "Solve Real Problems",
                    description:
                      "Encourage students to turn their ideas into solutions by working on real-world problems and meaningful projects.",
                  },
                  {
                    title: "Build the Future",
                    description:
                      "Help students develop the technical skills, confidence, creativity, and mindset they need to create, innovate, and grow in the tech world.",
                  },
                ].map((point) => (
                  <div
                    key={point.title}
                    className={`flex items-start gap-4 rounded-xl p-4 transition-colors duration-300 ${
                      dark
                        ...
                        : "bg-ink-50/5 hover:bg-ink-50/10"
                    }`}
                  >
                    <span
                      className={`mt-1 shrink-0 text-brand-500 text-lg leading-none`}
                    >
                      ❖
                    </span>
                    <div>
                ...
                {[
                  {
                    ...
                    description:
                      "Create a space where students can learn, build, experiment, and turn their ideas into real-world projects.",
                  },
                  {
                    title: "Empower the Next Generation",
                    description:
                      "Help students become confident developers, designers, creators, and innovators ready to shape the future.",
                  },
                  {
                    title: "Connect Talent with Opportunity",
                    description:
                      "Bridge the gap between students, communities, mentors, projects, hackathons, internships, and real-world opportunities.",
                  },
                  {
                    title: "Build What Comes Next",
                    description:
                      "Foster a culture of innovation where students don't just learn technology — they use it to create what's next.",
                  },
                ].map((point) => (
                  <div
                    key={point.title}
